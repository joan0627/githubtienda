                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <label>Nombre</label> 
                                <input name="nombre" type="text" class="form-control " value="Bruno" readonly="readonly">
                            </div>
                        </div>
                    </div>
                    <div class="row">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input name="Cumpleaños" type="text" class="form-control"  value="22/01/2011" readonly="readonly">
                            </div>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <textarea class="form-control" rows="3" placeholder="Ninguna" readonly="readonly"  ></textarea>
                            </div>
                        </div>
                    </div>
