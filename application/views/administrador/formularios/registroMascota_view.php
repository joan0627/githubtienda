            ...
            <form role="form" method="POST">
                ...
                <div class="card-body ">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="form-group">
                                ...
                                <input name="raza" type="text" class="form-control" placeholder="Ingrese la raza">
                            </div>
                        </div>
                        <div class="col-md-6">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input name="Cumpleaños" type="date" class="form-control"
                    ...
                    <div class="card-footer">
                        ...
                        <button id="botonActualizarCliente" class="btn btn-success col-2">Añadir</button>
                        <a href="<?php echo base_url();?>cliente/registrar" id="botonAtras"
