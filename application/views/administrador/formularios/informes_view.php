                    ...
                    <div class="card">
                        <div class="card-header p-2">
                            <ul class="nav nav-pills">
                                ...
                                <li class="nav-item "><a class="nav-link active" href="#clientes"
                            ...
                            <div class="tab-content">
                                <div class="active tab-pane " id="clientes">
									...
									<div class="row">
										...
										<p>Seleccione el rango de fecha en la que desea ver el informe de los clientes más frecuentes.</p>
                                ...
                                <div class="tab-pane" id="productos">
									...
									<div class="row">
										...
										<p>Seleccione el rango de fecha en la que desea ver el informe de los productos más vendidos.</p>
