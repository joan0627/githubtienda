 	...
 	<section class="content">
 		...
 		<div class="card">
 			<div class="card-header">
 				<h3 class="card-title">Términos de privacidad</h3>
 			...
 			<div class="card-body">
 				...
 				<p>&nbsp;</p>
 				<p>El presente Política de Privacidad establece los términos en que El rincón de la mascota usa y
 				...
 				<p>Nuestro sitio web emplea la información con el fin de proporcionar el mejor servicio posible,
 					...
 					ser cancelados en
 					cualquier momento.</p>
 				<p>El rincón de la mascota está altamente comprometido para cumplir con el compromiso de mantener su
 					información segura.
 				...
 				<p>Nuestro sitio web emplea las cookies para poder identificar las páginas que son visitadas y su
 					...
 					menos de que usted así lo quiera y la proporcione directamente, <a
 						href="https://recargalebara.es/como-activar-internet-lebara/" target="_blank">visitas a una web
 					</a>. Usted
 					puede aceptar o negar el uso de cookies, sin embargo la mayoría de navegadores aceptan cookies
 					automáticamente pues
 					sirve para tener un mejor servicio web. También usted puede cambiar la configuración de su
 					ordenador para declinar
 				...
 				<p>Este sitio web pudiera contener en laces a otros sitios que pudieran ser de su interés. Una vez que
 					usted de clic en
 					estos enlaces y abandone nuestra página, ya no tenemos control sobre al sitio al que es redirigido
 					y por lo tanto no
 				...
 				<p>El rincón de la mascota Se reserva el derecho de cambiar los términos de la presente Política de
 					Privacidad en
 					cualquier momento.</p>
