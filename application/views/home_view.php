    ...
    <div id="carouselExampleControls" class="carousel slide" data-ride="carousel">
      <div class="carousel-inner">
        <div class="carousel-item carrusel active">
          <img class="d-block w-100" src="<?php echo base_url();?>assets/assetshome/images/slider1.jpg" alt="First slide">
          <div class="carousel-caption d-none d-md-block">
            <h5>ARMONIA</h5>
            <p>Creamos un entorno de armonía entre tú y tus mascotas.</p>
          </div>
        </div>
        <div class="carousel-item">
          <img class="d-block w-100" src="<?php echo base_url();?>assets/assetshome/images/slider2.jpg" alt="Second slide">
          <div class="carousel-caption d-none d-md-block">
            <h5>CALIDAD</h5>
            <p>El mejor servicio, para tu mascota.</p>
          </div>
        </div>
        <div class="carousel-item">
          <img class="d-block w-100" src="<?php echo base_url();?>assets/assetshome/images/slider3.png" alt="Third slide">
           <div class="carousel-caption d-none d-md-block">
            <h5>Inigualable</h5>
...
<div class="row">
  <div class="col-md-6 col-lg-6 text-center">
    ...
    <h3 class="line-height-1 mb-3"><span class="d-block display-4 line-height-1 text-black">Bienvenido</span> <span class="d-block display-4 line-height-1"></span></h3>
    <p>La <strong>mirada de tu mascota</strong>  es el mejor espejo donde puedes comprobar la <strong>grandeza de tu alma</strong> </p>
 ...
 <div class=" col-lg-5">
  <div class="border border-success border rounded p-2 d-flex align-items-center justify-content-center h-100">
    <div class="text-center">
      <img  src="<?php echo base_url();?>assets/assetshome/images/horario.png" />
      <h2 class="text-primary h2 mb-3 horario">Horario</h2>
      <p class="mb-3">

        <span class="d-block font-weight-bold">Lunes – Sábado </span>
        07:00 AM – 6:00 PM
      </p>
            ...
            <div class="row">
              <div class="mb-4 mb-lg-0 col-lg-6 order-lg-2" data-aos="fade-left">
                <a href="#" class="rotate10">
                  <img src="<?php echo base_url();?>assets/assetshome/images/dog_3.jpg" alt="Image" class="img-fluid">
                </a>
              </div>
            ...
            <div class="row">
              <div class="mb-4 mb-lg-0 col-lg-6"  data-aos="fade-right">
                <a href="#" class="rotate-reverse10">
                  <img src="<?php echo base_url();?>assets/assetshome/images/mision.jpg" alt="Image" class="img-fluid">
                </a>
              </div>
              <div class="col-lg-5 ml-auto align-self-center"  data-aos="fade-left">
                ...
                <p class="mb-4">Ser una tienda de mascotas reconocida, que brinda una experiencia
                   ...
                   contando con el mejor talento humano en cada una de las áreas. Dar una solución
                    integral sobre la atención de la mascota, a partir de una inmejorable oferta de producto,
                     precio y servicio.</p>
        ...
        <div class="row hover-1-wrap mb-5 mb-lg-0">
          <div class="col-12">
            <div class="row">
              <div class="mb-4 mb-lg-0 col-lg-6 order-lg-2" data-aos="fade-left">
                <a href="#" class="rotate10">
                  <img src="<?php echo base_url();?>assets/assetshome/images/vision.jpg " alt="Image" class="img-fluid">
                </a>
              </div>
              <div class="col-lg-5 mr-auto text-lg-right align-self-center order-lg-1" data-aos="fade-right">
                <h2 class="text-black">Visión</h2>
                <p class="mb-4">Ser líderes en la distribución de productos y accesorios de alta calidad para mascotas,
                   logrando llegar a los corazones de nuestros clientes, superando sus expectativas y estableciendo
      ...
      <div class="container">
        <div class="row">
          ...
          <div class="col-md-6" data-aos="fade-right">
            <img class="img-fluid border10 rotate-reverse10" src="<?php echo base_url();?>assets/assetshome/images/dog_doctor.jpg" alt="Image">
          </div>
          <div class="col-md-5 ml-auto align-self-center" data-aos="fade-left">
            <h2 class="mb-2 heading mb-4">Acerca de <strong>mi</strong> </h2>
            <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Iste amet praesentium tenetur quos eius asperiores incidunt <a href="#">reprehenderit</a> hic labore? Officiis enim laborum facere iure voluptatem autem veritatis cupiditate magnam saepe.</p>
            <p>Nulla, beatae ducimus? Dolor distinctio tempore hic consequatur, magni consectetur possimus tenetur eius, placeat, eveniet facilis perferendis vitae deleniti incidunt! Incidunt, illum eum? Suscipit aliquid consequatur repudiandae doloremque est nisi.</p>
    ...
    <section class="site-section bg-light trainers" id="productos">
      <div class="container">
        <div class="row">
            ...
            <img class="img-fluid border10 rotate-reverse10" data-aos="fade-left" src="<?php echo base_url();?>assets/assetshome/images/productos.png" alt="Image">
          </div>
      ...
      <div class="container" id="accordion">
        ...
        <div class="row accordion justify-content-center block__76208">
          <div class="col-lg-6 order-lg-1 mb-5 mb-lg-0" data-aos="fade-up"  data-aos-delay="">
            <img src="<?php echo base_url();?>assets/assetshome/images/dog_5.jpg" alt="Image" class="img-fluid rounded">
          </div>
          <div class="col-lg-5 ml-auto order-lg-2 align-self-center" data-aos="fade-up"  data-aos-delay="100">
            <div class="accordion-item">
              <h3 class="mb-0 heading">
                <a class="btn-block" data-toggle="collapse" href="#collapseFive" role="button" aria-expanded="true" aria-controls="collapseFive">¿Cuándo debo vacunar a mi mascota?<span class="icon"></span></a>
              </h3>
            ...
            <div class="accordion-item">
              <h3 class="mb-0 heading">
                <a class="btn-block" data-toggle="collapse" href="#collapseSix" role="button" aria-expanded="false" aria-controls="collapseSix">¿Por qué debo desparasitar a mi mascota? <span class="icon"></span></a>
              </h3>
            ...
            <div class="accordion-item">
              <h3 class="mb-0 heading">
                <a class="btn-block" data-toggle="collapse" href="#collapseSeven" role="button" aria-expanded="false" aria-controls="collapseSeven">¿Cómo debo alimentar a mi perro o a mi gato?<span class="icon"></span></a>
              </h3>
            ...
            <div class="accordion-item">
              <h3 class="mb-0 heading">
                <a class="btn-block" data-toggle="collapse" href="#collapseEight" role="button" aria-expanded="false" aria-controls="collapseEight">¿Cada cuánto tiempo es recomendable bañar a mi mascota?<span class="icon"></span></a>
              </h3>
          ...
          <div class="owl-carousel nonloop-block-13">
            <div>
              <div class="block-testimony-1 text-center">
                ...
                <figure>
                  <img src="<?php echo base_url();?>assets/assetshome/images/person_1.jpg" alt="Image" class="img-fluid rounded-circle mx-auto">
                </figure>
            ...
            <div>
              <div class="block-testimony-1 text-center">
                ...
                <figure>
                  <img src="<?php echo base_url();?>assets/assetshome/images/person_2.jpg" alt="Image" class="img-fluid rounded-circle mx-auto">
                </figure>
            ...
            <form action="#" class="p-5 contact-form">
              ...
              <div class="row form-group">
                <div class="col-md-12">
                  ...
                  <textarea name="message" id="message" cols="30" rows="7" class="form-control" placeholder="Escribe aquí tu mensaje..."></textarea>
                </div>
              </div>
