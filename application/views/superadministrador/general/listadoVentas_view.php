		...
		<div class="container-fluid">
			...
			<div class="col-auto col-md-6 mr-auto ">
                ...
                <div class="col-auto">
                    ...
                    <a href="<?php echo base_url();?>venta/registrarventasu" class="btn btn-success"><i class="fas fa-plus-circle"></i> Crear venta</a>
                </div>
            </div>
        </div>
					...
					<tbody>
						...
						<tr>
							...
							<td class="project-actions text-right ">
								...
								<a class="btn btn-info btn-sm" href="actualizarventasu">
