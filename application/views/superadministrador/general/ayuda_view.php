...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1><img src="<?php echo base_url();?>assets/img/iconos/icons8-signo-de-interrogación-50.png"> Ayuda</h1>
                </div>
          ...
          <div class="col-lg-12">
            <div class="card">
              <div class="card-header">
                <h5 class="m-0">Bienvenido a la ayuda de IntraRuk</h5>
              </div>
              <div class="card-body">
                <h6 class="card-title">Acceso al manual de usuario</h6>
