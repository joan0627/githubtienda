    ...
    <div class="login-dark">
        <form action="<?php echo base_url();?>login/preguntaSeguridad" method="post">
			...
			<div class="form-group">
                <select class="form-control" type="text" name="pregunta" placeholder="-Seleccione una pregunta de seguridad-">          
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        <a class="btn btn-primary btn-block" href="<?php echo base_url();?>login"><i class="fas fa-times-circle"></i> Cancelar</a>
                    </div>
                </div>
            </div>

            <div class="form-group"><input type="hidden" name="idUsuario" value="<?= $idUsuario; ?>"></div>
            <div class="form-group"><input type="hidden" name="nombreUsuario" value="<?= $nombre; ?>"></div>
