					...
					*/
                    ...
                    <div class="row">
                        <div class="col-md-3">
                            <div class="form-group">
                                <label>Cliente</label>
                                <input name="celular" type="text" class="form-control" value="Luis David Sánchez Cano"
                                    readonly="readonly">
                            </div>
						...
						<div class="col-md-3">
                            <div class="form-group">
                                <label>Mascota</label>
                                <input name="celular" type="text" class="form-control" value="Bruno"
                                    readonly="readonly">
                            </div>
						...
						<div class="col-md-3">
                            <div class="form-group">
                                ...
                                <input name="celular" type="text" class="form-control" value="Peluqueria"
                                    readonly="readonly">
                            </div>
                        ...
                        <table class="table table-striped">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td><span class="pull-right">$145.000</span></td>
                                    <td></td>
                                </tr>
                                ...
                                <div class="container-fluid">
                                    <div class="row mb-1">
                                        ...
                                        <div class="col-auto">
                                            ...
                                            <a href="guardar" class="btn btn-success"><i class="fas fa-plus-circle"></i>
                                                Crear producto</a>
                                        </div>
