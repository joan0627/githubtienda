    ...
    <section class="content">
        ...
        <div class="card  card-success">
            ...
            <div class="card-header">
                <h3 class="card-title">Registrar una cita </h3>
			...
			<div class="col-auto float-right" style="">

                <a href="<?php echo base_url();?>cliente/crearclientesu" class="btn btn-success"><i class="fas fa-plus-circle"></i>
                    Crear cliente</a>
			</div>
