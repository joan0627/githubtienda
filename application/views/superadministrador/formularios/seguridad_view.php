                    ...
                    <div class="card">
                        <div class="card-header p-2">
                            <ul class="nav nav-pills ">
                                ...
                                <li class="nav-item"><a class="nav-link" href="#cambiocontrasena"
                                        data-toggle="tab">Cambiar
                                        contraseña</a>
                                </li>
                            </ul>
                        </div><!-- /.card-header -->
                                    ...
                                    <form id="form-pregunta" action="" method="post" class="form-horizontal">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <div class="form-group">
                                                    <label>Pregunta de seguridad</label> <label
                                                        style="color: red;">*</label>

                                                    <select name="preguntaSeguridad" id="preguntaSeguridad"
                                                        class="form-control">

                                                        <?php foreach ($preguntaactual as $clave => $valor): ?>

                                                        <option hidden
                                                            value=" <?php echo $valor->idPreguntaSeguridad; ?>"
                                                            selected><?php echo $valor->pregunta; ?></option>
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <div class="form-group">
                                                    <label>Nueva respuesta</label> <label style="color: red;">*</label>
                                                    <input name="respuesta" id="respuesta" type="text"
                                                        class="form-control "
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input name="contrasenaactualpre" id="contrasenaactualpre"
                                        ...
                                        <div class="text-center card-footer">
                                            ...
                                            <button style="padding: 10px 5px; margin: 10px 5px;   margin: 5 auto;"
                                                type="submit" id="botonactualizarPregunta"
                                                class="btn btn-success col-2"><i class="fas fa-save"></i>
                                                Actualizar</button>
                                    ...
                                    <form id="form-contrasena" action="" method="post" class="form-horizontal">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <div class="form-group">
                                                    <label>Nueva contraseña</label> <label style="color: red;">
                                                        *</label>
                                                    <input name="nuevacontrasena" id="nuevacontrasena" type="password"
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <div class="form-group">
                                                    <label>Confirmar nueva contraseña</label> <label
                                                        style="color: red;">
                                                        *</label>
                                                    <input name="confirmcontrasena" type="password" autocomplete="off"
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                ...
                                                <div class="form-group">
                                                    <label>Contraseña actual</label> <label style="color: red;">
                                                        *</label>
                                                    <input name="contrasenaactual" id="contrasenaactual" type="password"
                                                        autocomplete="off" class="form-control"
                                                        placeholder="Ingrese su contraseña actual">
                                                </div>
                                        ...
                                        <div class="text-center card-footer">
                                            ...
                                            <button style="padding: 10px 5px; margin: 10px 5px;   margin: 5 auto;"
                                                type="submit" id="botonactualizarContrasena"
                                                class="btn btn-success col-2"><i class="fas fa-save"></i>
                                                Actualizar</button>
                                            <a style="padding: 10px 5px; margin: 10px 5px;   margin: 5 auto;"
                                                href="<?php echo base_url(); ?>inicio" class="btn btn-success col-2"><i
