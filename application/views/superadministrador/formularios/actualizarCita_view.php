                ...
                <div class="card-body ">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-2">
                            ...
                            <a href="<?php echo base_url();?>venta/registrarventaservicio" id=""
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <select name="servicio" class="form-control select2bs4">

                                    <option hidden selected>-Seleccione el responsable del servicio-</option>
                                    <option value="1">Joan Bolivar</option>
                                    <option value="2">David Sánchez</option>
                                    <option value="2">Fred Gil</option>
                                </select>
                            </div>
                        </div>
