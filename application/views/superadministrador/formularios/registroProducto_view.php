			...
			<form role="form" action="" name="producto" method="POST" enctype="multipart/form-data">
				...
				<div class="card-body ">
					<div class="row">
						<div class="col-md-6">
							<div class="form-group">
								...
								<input name="codigo" type="text" class="form-control " placeholder="Ingrese el codigo " value="<?php echo $idProducto;?>">
						...
						<div class="col-md-6">
							...
							<div class="form-group">
								...
								<input name="nombre" type="text" class="form-control" placeholder="Ingrese el nombre"  value="<?php echo $nombreProducto;?>">
					...
					<div class="row">
						...
						<div class="col-md-6">
							<div class="form-group">
								...
								<textarea class="form-control" rows="2" placeholder="Escribe una descripción del producto ..." name="descripcion"><?php echo $descripcion;?>
</textarea>
					...
					<div class="row">
						...
						<div class="col-md-6">
							<div class="form-group">
								...
								<input name="existencia" type="number" class="form-control" placeholder="Ingrese la existencia" 
								value="<?php echo $existencia;?>" min="1">
						...
						<div class="col-md-6">
							<div class="form-group">
								...
								<input name="valorDeMedida" type="text" class="form-control" placeholder="Ingrese el valor de medida" 
								value="<?php echo $valorMedida;?>">
					...
					<div class="row">
						...
						<div class="col-md-4">
							...
							<div class="form-group input-group">
								...
								value="<?php echo $utilidad;?>" min="1" max="99">
							</div>
						...
						<div class="col-md-4">
							...
							<div class="form-group input-group">
								...
								<input type="text" class="form-control" placeholder="" readOnly="readonly" id="total" name="precioVenta" 
					...
					<div class="row">
						<div class="col-md-6">
							<div class="form-group">
								<label for="exampleInputFile">Imagen <?php echo $img;?></label>

								<div class="input-group">
									<div class="custom-file">
										<input type="file"  id="cargaimagenproducto" name="cargaimagenproducto">
									</div>
						...
						<div class="col-md-6">
							<div class="form-group">
								...
								<div class="timeline-body">
									<img style="width: 250px; height: 200px;" id="vistapreviaproducto" src="<?php echo $img;?>" alt="¡El archivo no es compatible!">
