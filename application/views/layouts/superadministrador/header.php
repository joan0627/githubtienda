...
<head>
	...
	<!-- DataTable Select-->
	<link rel="stylesheet"
		href="<?php echo base_url();?>assets/plugins/datatables/Select-1.3.1/css/select.dataTables.min.css">
	...
	<link rel="stylesheet"
		href="<?php echo base_url();?>assets/plugins/plugins/bootstrap-colorpicker/css/bootstrap-colorpicker.min.css">
	...
	<link rel="stylesheet"
		href="<?php echo base_url();?>assets\plugins\plugins\select2-bootstrap4-theme/select2-bootstrap4.css">

	<!-- Clock Picker -->
	<link rel="stylesheet"
		href="<?php echo base_url();?>assets/plugins/plugins/clockpicker-gh-pages/src/clockpicker.css">
	<link rel="stylesheet"
		href="<?php echo base_url();?>assets/plugins/plugins/Easy-Clock-Time-Picker/css/clockface.css">
	...
	<!-- DateTable Botones -->
	<script src="<?php echo base_url(); ?>assets/plugins/datatables/Buttons-1.6.3/js/dataTables.buttons.min.js">
	</script>
	...
	<script
		src="<?php echo base_url(); ?>assets/plugins/plugins/currencyFormatter.js-master/dist/currencyFormatter.min.js">
	</script>
			...
			<ul class="navbar-nav ml-auto">
				...
				<li class="nav-item dropdown user-body">
					<a class="nav-link" data-toggle="dropdown" href="#">
						...
						<span id="contadorN" style="font-size:12px; right:14px; top:4px;"
				...
				<li class=" dropdown user user-menu">
					<a href="#" class="  nav-link" data-toggle="dropdown">
						...
						<?php } ?>
						<span
							class="hidden-xs"><?php if ($nombre= $this->session->userdata("nombre")){ echo $nombre;}   ?>
							<i class="fas fa-angle-down right"></i> </span>
					</a>
					<ul class="dropdown-menu  dropdown-menu-right">
						<li class="user-body">
							<div class="row">
								<div class="col-xs-12 text-center">
									<a href="<?php echo base_url();?>configuracion/seguridad"><img
											src="<?php echo base_url();?>assets/img/iconos/icons8-bloquear-30.png"
							...
							<div class="row">
								<div class="col-xs-12 text-center">
									<a id='cerrarsesion' href=""><img
											src="<?php echo base_url();?>assets/img/iconos/icons8-apagar-26.png"
